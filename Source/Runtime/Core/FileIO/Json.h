...
#pragma region Make Json Value Declare
	...
	template<>
	rapidjson::Value makeJsonValue(const HLinearColor& value);
...
#pragma region Read Json Value Declare
	...
	template<>
	bool readJsonValue(int8* value) const;

	template<>
	bool readJsonValue(int16* value) const;
	...
	template<>
	bool readJsonValue(uint8* value) const;

	template<>
	bool readJsonValue(uint16* value) const;
	...
	template<>
	bool readJsonValue(HLinearColor* value) const;
...
template<>
inline rapidjson::Value PJsonData::makeJsonValue(const HLinearColor& value)
{
	rapidjson::Value valArr; valArr.SetArray();
	pushValueInJsonValue(valArr, value.R);
	pushValueInJsonValue(valArr, value.G);
	pushValueInJsonValue(valArr, value.B);
	pushValueInJsonValue(valArr, value.A);
...
template<>
inline bool PJsonData::readJsonValue(int8* value) const
{
...
template<>
inline bool PJsonData::readJsonValue(int16* value) const
{
	if (_value.IsInt() == false || value == nullptr)
	{
		return false;
...
template<>
inline bool PJsonData::readJsonValue(uint8* value) const
{
...
template<>
inline bool PJsonData::readJsonValue(uint16* value) const
{
	if (_value.IsUint() == false || value == nullptr)
	{
		return false;
...
template<>
inline bool PJsonData::readJsonValue(HLinearColor* value) const
{
	if (_value.IsArray() == false || value == nullptr)
	{
		return false;
	...
	PJsonData jsonData;
	bResult &= FindMemberFromIndex(0, &jsonData);
	bResult &= getValueInJsonValue(jsonData._value, &(value->R));

	bResult &= FindMemberFromIndex(1, &jsonData);
	bResult &= getValueInJsonValue(jsonData._value, &(value->G));

	bResult &= FindMemberFromIndex(2, &jsonData);
	bResult &= getValueInJsonValue(jsonData._value, &(value->B));

	bResult &= FindMemberFromIndex(3, &jsonData);
	bResult &= getValueInJsonValue(jsonData._value, &(value->A));
