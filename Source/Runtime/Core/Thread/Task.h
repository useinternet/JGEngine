...
private:
	...
	const HAtomicBool* pIsCompelete;
private:
	HTaskHandle(PSharedPtr<PTask> inTask, const HAtomicBool* pInIsRunning, const HAtomicBool* pInIsCompelete);
