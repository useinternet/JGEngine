...
const PName& PDX12FrameBuffer::GetName() const
{
	return _name;
}

void PDX12FrameBuffer::SetName(const PName& inName)
{
	_name = inName;
}
...
void PDX12FrameBuffer::SubmitTexture(PSharedPtr<IRawTexture> inTexture)
{
